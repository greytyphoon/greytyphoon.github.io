Greytyphoon.Characters.push({
	...
	meta: {
		quest: "Psychose",
		owner: "Supi",
		companion: { name: "Ligre", url: "https://d20pfsrd.com/classes/core-classes/druid/animal-companions#TOC-Cat-Big" }
	},
	alignment: "NG",
	deity: "",
	languages: "Common, Elven, Dwarven, Celestial",
	ancestry: { name: "Half-Elf",  url: "https://d20pfsrd.com/races/core-races/half-elf" },
	level: [ { name: "Hunter", url: "https://d20pfsrd.com/classes/hybrid-classes/hunter", quantity: 3 } ],
	"str": 10,
	...
	"cha": 10,
	traits: [
		{ name: "Heavenly Touch", url: "https://d20pfsrd.com/traits/regional-traits/heavenly-touch-tianjing" },
		{ name: "Grim Optimism", url: "https://d20pfsrd.com/traits/social-traits/grim-optimi" }
	],
	startingFeats: [
	...
	progressFeats: [
		{ name: "Precise Shot", reason: "Hunter 2", url: "https://d20pfsrd.com/feats/combat-feats/precise-shot-combat" },
		{ name: "Mounted Combat", reason: "Level 3", url: "https://d20pfsrd.com/feats/combat-feats/mounted-combat-combat" },
		{ name: "Coordinated Shot", reason: "Hunter 3", url: "https://d20pfsrd.com/feats/combat-feats/coordinated-shot-combat-teamwork" }
	],
	targetFeats: [],
	spells: [
		{ level: 1, name: "acid maw", url: "https://d20pfsrd.com/magic/all-spells/a/acid-maw" },
		{ level: 1, name: "charm animal", url: "https://d20pfsrd.com/magic/all-spells/c/charm-animal" },
